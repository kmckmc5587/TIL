...
```python
director = Director.objects.filter(name = '봉준호').values()[0]

for i in director:
    print(f'{i} : {director[i]}')
```
...
```python
for object in Movie.objects.all():
...
```python
object = Movie.objects.all().order_by('opening_date')[0]
print(object.director.name,
    object.genre.title, 
    object.title,
    object.opening_date, 
...
```python
for object in Movie.objects.all().order_by('opening_date'):
    if object.screening == True:
        print(object.director.name,
            object.genre.title, 
            object.title,
            object.opening_date, 
...
object = Movie.objects.filter(director = bong_id).order_by('opening_date')[1]
print(object.director.name,
        object.genre.title, 
        object.title,
        object.opening_date, 
...
```python
for object in Movie.objects.all().order_by('running_time'):
    if object.running_time > 119:
        print(object.director.name,
            object.genre.title, 
            object.title,
            object.opening_date, 
...
```python
for object in Movie.objects.filter(opening_date__gte = '2022-01-01').order_by('opening_date'):
        print(object.director.name,
            object.genre.title, 
            object.title,
            object.opening_date, 
...
for object in Movie.objects.filter(director = bong_id, genre = drama_id).order_by('opening_date'):
            print(object.director.name,
            object.genre.title, 
            object.title,
            object.opening_date, 
...
```python
bong_id = Director.objects.get(name = '봉준호').id
for object in Movie.objects.exclude(director = bong_id).order_by('opening_date'):
            print(object.director.name,
            object.genre.title, 
            object.title,
            object.opening_date, 
